...
import { Play, Square, Settings2, Activity, TrendingUp, Zap, Target, CheckCircle2, XCircle, AlertCircle, ArrowRight, Rocket } from 'lucide-react';
import { cn } from '../../lib/utils';
import { toast } from 'sonner';
import { useBotAstron } from '../../hooks/useBotAstron';
...
export const AstronPanel: React.FC<AstronPanelProps> = ({ isActive, onToggle, onBack }) => {
    ...
    const { isRunning, stats, logs, startBot, stopBot } = useBotAstron();
            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-black text-white mb-1 tracking-tight">Astron Bot</h1>
                            <p className="text-sm text-white/40">Estrategia Over/Under con alternancia automática</p>
                        </div>
                    </div>
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                isRunning
                                    ...
                                    : "bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white border-none shadow-lg shadow-cyan-500/25"
                            )}
                        >
                            {isRunning ? (
                                <>
                            ...
                            <div className="h-[400px] overflow-y-auto scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
                                {logs.length === 0 ? (
                                    <div className="h-full flex flex-col items-center justify-center p-12">
                                        <div className="w-20 h-20 rounded-2xl bg-cyan-500/5 flex items-center justify-center mb-4 border border-cyan-500/10">
                                            <Rocket size={32} className="text-cyan-400/50" />
                                        </div>
