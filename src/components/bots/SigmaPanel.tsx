...
export const SigmaPanel = ({ isActive, onToggle, onBack }: SigmaPanelProps) => {
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        disabled={isRunning}
                                        className="w-full pl-7 pr-4 py-2.5 bg-black/40 border border-white/10 rounded-lg text-white text-sm font-mono focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/20 transition-all outline-none disabled:opacity-40 disabled:cursor-not-allowed"
                                        step="0.01"
                                    />
                                </div>
                            </div>

                            {/* Fila Predicción y Martingale */}
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <select
                                        ...
                                        disabled={isRunning}
                                        className="w-full px-3 py-2.5 bg-black/40 border border-white/10 rounded-lg text-white text-sm font-mono focus:border-purple-500/50 transition-all outline-none disabled:opacity-40 disabled:cursor-not-allowed"
                                    >
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            disabled={isRunning}
                                            className="w-full pl-7 pr-3 py-2.5 bg-black/40 border border-white/10 rounded-lg text-white text-sm font-mono focus:border-purple-500/50 transition-all outline-none disabled:opacity-40 disabled:cursor-not-allowed"
                                            step="0.1"
                                        />
                                    </div>
                                </div>
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                isRunning
                                    ...
                                    : "bg-purple-500/10 border-purple-500/30 text-purple-400 hover:bg-purple-500/20 hover:border-purple-500/50 hover:shadow-lg hover:shadow-purple-500/10"
                            )}
                        >
                            {isRunning ? (
                                <>
                    ...
                    <div className="grid grid-cols-4 gap-3">
                        ...
                        <div className="relative overflow-hidden rounded-xl p-4 bg-slate-900/50 backdrop-blur-xl border border-white/10">
                            <div className="flex items-center gap-1.5 mb-2">
                                ...
                                <span className="text-[10px] font-bold uppercase tracking-widest text-purple-400/60">Stake</span>
                            </div>
