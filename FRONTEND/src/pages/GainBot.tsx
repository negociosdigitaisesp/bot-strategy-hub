...
import { Play, Square, Settings2, Activity, TrendingUp, Zap, Shield, BarChart3, Target, CheckCircle2, XCircle, AlertCircle, ArrowRight, DollarSign } from 'lucide-react';
...
const GainBot = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#0a0f0a] via-[#0f140f] to-[#0a0f0a] p-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <div className="relative">
                            ...
                            <div className="relative w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center border border-emerald-400/20">
                                <DollarSign className="text-white" size={28} />
                            </div>
                        </div>
                        <div>
                            <h1 className="text-3xl font-black text-white mb-1 tracking-tight">Gain Bot</h1>
                            <p className="text-sm text-white/40">Estrategia Smart Recovery (R_100)</p>
                        </div>
                    </div>
                    ...
                    <div className={cn(
                        ...
                        <span className={cn(
                            ...
                            isRunning ? "text-emerald-400" : "text-white/50"
                        )}>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        disabled={isRunning}
                                        className="w-full px-4 py-3 bg-black/40 border border-white/10 rounded-xl text-white font-mono focus:border-emerald-500/50 focus:ring-2 focus:ring-emerald-500/20 transition-all outline-none disabled:opacity-50"
                                        step="0.01"
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        disabled={isRunning}
                                        className="w-full px-4 py-3 bg-black/40 border border-white/10 rounded-xl text-white font-mono focus:border-emerald-500/50 transition-all outline-none disabled:opacity-50"
                                        step="0.1"
                                    />
                                    <p className="text-[10px] text-white/30 mt-1">
                                        Divisor para el cálculo de recuperación.
                                    </p>
                                </div>
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                isRunning
                                    ...
                                    : "bg-gradient-to-r from-emerald-600 to-teal-500 hover:from-emerald-500 hover:to-teal-600 text-white border-none shadow-lg shadow-emerald-500/25"
                            )}
                        >
                            {isRunning ? (
                                <>
                                ...
                                {logs.length === 0 ? (
                                    <div className="h-full flex flex-col items-center justify-center p-12">
                                        <div className="w-20 h-20 rounded-2xl bg-emerald-500/5 flex items-center justify-center mb-4 border border-emerald-500/10">
                                            <Target size={32} className="text-emerald-400/50" />
                                        </div>
